...
public class ConstrutorView {
    ...
    public ConstrutorView(String AGRUPAMENTO_1, String AGRUPAMENTO_2, String DESCRICAO_AGRUPAMENTO1, String DESCRICAO_AGRUPAMENTO2, String CURVAMES01, String CURVAMES02, String CURVAMES03, String CURVAMES04, String CURVAMES05, String CURVAMES06, String CURVAMES07, String CURVAMES08, String CURVAMES09, String CURVAMES10, String CURVAMES11, String CURVAMES12, String CURVAMES13, String CURVAGERAL, int MES01, int MES02, int MES03, int MES04, int MES05, int MES06, int MES07, int MES08, int MES09, int MES10, int MES11, int MES12, int MES13, float PART_GR1, float ACU_GR1, float CMV, float CMV_GERAL, float CMV_PARTICIPACAO_GERAL, float ACUM_CMV_PARTICIPACAO_GERAL, float VENDIDO, float VENDIDO_GR1, float VENDIDO_GERAL, float PARTICIPACAO_GERAL, float ACUM_PARTICIPACAO_GERAL, float MEDIA, float GR1_MES01, float GR1_MES02, float GR1_MES03, float GR1_MES04, float GR1_MES05, float GR1_MES06, float GR1_MES07, float GR1_MES08, float GR1_MES09, float GR1_MES10, float GR1_MES11, float GR1_MES12, float GR1_MES13, float PART_GR1_MES01, float PART_GR1_MES02, float PART_GR1_MES03, float PART_GR1_MES04, float PART_GR1_MES05, float PART_GR1_MES06, float PART_GR1_MES07, float PART_GR1_MES08, float PART_GR1_MES09, float PART_GR1_MES10, float PART_GR1_MES11, float PART_GR1_MES12, float PART_GR1_MES13, float ACU_GR1_MES01, float ACU_GR1_MES02, float ACU_GR1_MES03, float ACU_GR1_MES04, float ACU_GR1_MES05, float ACU_GR1_MES06, float ACU_GR1_MES07, float ACU_GR1_MES08, float ACU_GR1_MES09, float ACU_GR1_MES10, float ACU_GR1_MES11, float ACU_GR1_MES12, float ACU_GR1_MES13, float GERAL_MES01, float GERAL_MES02, float GERAL_MES03, float GERAL_MES04, float GERAL_MES05, float GERAL_MES06, float GERAL_MES07, float GERAL_MES08, float GERAL_MES09, float GERAL_MES10, float GERAL_MES11, float GERAL_MES12, float GERAL_MES13, float PARTICIPACAO_GERAL_MES01, float PARTICIPACAO_GERAL_MES02, float PARTICIPACAO_GERAL_MES03, float PARTICIPACAO_GERAL_MES04, float PARTICIPACAO_GERAL_MES05, float PARTICIPACAO_GERAL_MES06, float PARTICIPACAO_GERAL_MES07, float PARTICIPACAO_GERAL_MES08, float PARTICIPACAO_GERAL_MES09, float PARTICIPACAO_GERAL_MES10, float PARTICIPACAO_GERAL_MES11, float PARTICIPACAO_GERAL_MES12, float PARTICIPACAO_GERAL_MES13, float ACUM_GR1_MES01, float ACUM_GR1_MES02, float ACUM_GR1_MES03, float ACUM_GR1_MES04, float ACUM_GR1_MES05, float ACUM_GR1_MES06, float ACUM_GR1_MES07, float ACUM_GR1_MES08, float ACUM_GR1_MES09, float ACUM_GR1_MES10, float ACUM_GR1_MES11, float ACUM_GR1_MES12, float ACUM_GR1_MES13) {
