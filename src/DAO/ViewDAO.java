...
// <editor-fold>
        String mioloSql;
        if (filtros.venda_faturamento == 1) {
            mioloSql = "                (select decode(" + filtros.agrupamento + "	\n"
            ...
            while (rs.next()) {
                ...
                switch (filtros.agrupamento) {
                    ...
                    case 10:
                        ...
                        view.setCURVAMES01(calc.calculoAbc(rs.getInt("mes01"), rs.getFloat("participacao_geral_mes01"), rs.getFloat("acum_gr1_mes01"), filtros.curvaA, filtros.curvaB));
                        view.setMES02(rs.getInt("mes02"));
                        view.setCURVAMES02(calc.calculoAbc(rs.getInt("mes02"), rs.getFloat("participacao_geral_mes02"), rs.getFloat("acum_gr1_mes02"), filtros.curvaA, filtros.curvaB));
                        view.setMES03(rs.getInt("mes03"));
                        view.setCURVAMES03(calc.calculoAbc(rs.getInt("mes03"), rs.getFloat("participacao_geral_mes03"), rs.getFloat("acum_gr1_mes03"), filtros.curvaA, filtros.curvaB));
                        view.setMES04(rs.getInt("mes04"));
                        view.setCURVAMES04(calc.calculoAbc(rs.getInt("mes04"), rs.getFloat("participacao_geral_mes04"), rs.getFloat("acum_gr1_mes04"), filtros.curvaA, filtros.curvaB));
                        view.setMES05(rs.getInt("mes05"));
                        view.setCURVAMES05(calc.calculoAbc(rs.getInt("mes05"), rs.getFloat("participacao_geral_mes05"), rs.getFloat("acum_gr1_mes05"), filtros.curvaA, filtros.curvaB));
                        view.setMES06(rs.getInt("mes06"));
                        view.setCURVAMES06(calc.calculoAbc(rs.getInt("mes06"), rs.getFloat("participacao_geral_mes06"), rs.getFloat("acum_gr1_mes06"), filtros.curvaA, filtros.curvaB));
                        view.setMES07(rs.getInt("mes07"));
                        view.setCURVAMES07(calc.calculoAbc(rs.getInt("mes07"), rs.getFloat("participacao_geral_mes07"), rs.getFloat("acum_gr1_mes07"), filtros.curvaA, filtros.curvaB));
                        view.setMES08(rs.getInt("mes08"));
                        view.setCURVAMES08(calc.calculoAbc(rs.getInt("mes08"), rs.getFloat("participacao_geral_mes08"), rs.getFloat("acum_gr1_mes08"), filtros.curvaA, filtros.curvaB));
                        view.setMES09(rs.getInt("mes09"));
                        view.setCURVAMES09(calc.calculoAbc(rs.getInt("mes09"), rs.getFloat("participacao_geral_mes09"), rs.getFloat("acum_gr1_mes09"), filtros.curvaA, filtros.curvaB));
                        view.setMES10(rs.getInt("mes10"));
                        view.setCURVAMES10(calc.calculoAbc(rs.getInt("mes10"), rs.getFloat("participacao_geral_mes10"), rs.getFloat("acum_gr1_mes10"), filtros.curvaA, filtros.curvaB));
                        view.setMES11(rs.getInt("mes11"));
                        view.setCURVAMES11(calc.calculoAbc(rs.getInt("mes11"), rs.getFloat("participacao_geral_mes11"), rs.getFloat("acum_gr1_mes11"), filtros.curvaA, filtros.curvaB));
                        view.setMES12(rs.getInt("mes12"));
                        view.setCURVAMES12(calc.calculoAbc(rs.getInt("mes12"), rs.getFloat("participacao_geral_mes12"), rs.getFloat("acum_gr1_mes12"), filtros.curvaA, filtros.curvaB));
                        view.setMES13(rs.getInt("mes13"));
                        view.setCURVAMES13(calc.calculoAbc(rs.getInt("mes13"), rs.getFloat("participacao_geral_mes13"), rs.getFloat("acum_gr1_mes13"), filtros.curvaA, filtros.curvaB));
                        ...
                        view.setCURVAGERAL(calc.calculoAbc(rs.getInt("acum_participacao_geral"), rs.getFloat("participacao_geral"), rs.getFloat("acum_participacao_geral"), filtros.curvaA, filtros.curvaB));
                    ...
                    case 7:
                        ...
                        view.setMES01(rs.getInt("mes01"));
                        view.setCURVAMES01(calc.calculoAbc(rs.getInt("mes01"), rs.getFloat("part_gr1_mes01"), rs.getFloat("acu_gr1_mes01"), filtros.curvaA, filtros.curvaB));
                        view.setMES02(rs.getInt("mes02"));
                        view.setCURVAMES02(calc.calculoAbc(rs.getInt("mes02"), rs.getFloat("part_gr1_mes02"), rs.getFloat("acu_gr1_mes02"), filtros.curvaA, filtros.curvaB));
                        view.setMES03(rs.getInt("mes03"));
                        view.setCURVAMES03(calc.calculoAbc(rs.getInt("mes03"), rs.getFloat("part_gr1_mes03"), rs.getFloat("acu_gr1_mes03"), filtros.curvaA, filtros.curvaB));
                        view.setMES04(rs.getInt("mes04"));
                        view.setCURVAMES04(calc.calculoAbc(rs.getInt("mes04"), rs.getFloat("part_gr1_mes04"), rs.getFloat("acu_gr1_mes04"), filtros.curvaA, filtros.curvaB));
                        view.setMES05(rs.getInt("mes05"));
                        view.setCURVAMES05(calc.calculoAbc(rs.getInt("mes05"), rs.getFloat("part_gr1_mes05"), rs.getFloat("acu_gr1_mes05"), filtros.curvaA, filtros.curvaB));
                        view.setMES06(rs.getInt("mes06"));
                        view.setCURVAMES06(calc.calculoAbc(rs.getInt("mes06"), rs.getFloat("part_gr1_mes06"), rs.getFloat("acu_gr1_mes06"), filtros.curvaA, filtros.curvaB));
                        view.setMES07(rs.getInt("mes07"));
                        view.setCURVAMES07(calc.calculoAbc(rs.getInt("mes07"), rs.getFloat("part_gr1_mes07"), rs.getFloat("acu_gr1_mes07"), filtros.curvaA, filtros.curvaB));
                        view.setMES08(rs.getInt("mes08"));
                        view.setCURVAMES08(calc.calculoAbc(rs.getInt("mes08"), rs.getFloat("part_gr1_mes08"), rs.getFloat("acu_gr1_mes08"), filtros.curvaA, filtros.curvaB));
                        view.setMES09(rs.getInt("mes09"));
                        view.setCURVAMES09(calc.calculoAbc(rs.getInt("mes09"), rs.getFloat("part_gr1_mes09"), rs.getFloat("acu_gr1_mes09"), filtros.curvaA, filtros.curvaB));
                        view.setMES10(rs.getInt("mes10"));
                        view.setCURVAMES10(calc.calculoAbc(rs.getInt("mes10"), rs.getFloat("part_gr1_mes10"), rs.getFloat("acu_gr1_mes10"), filtros.curvaA, filtros.curvaB));
                        view.setMES11(rs.getInt("mes11"));
                        view.setCURVAMES11(calc.calculoAbc(rs.getInt("mes11"), rs.getFloat("part_gr1_mes11"), rs.getFloat("acu_gr1_mes11"), filtros.curvaA, filtros.curvaB));
                        view.setMES12(rs.getInt("mes12"));
                        view.setCURVAMES12(calc.calculoAbc(rs.getInt("mes12"), rs.getFloat("part_gr1_mes12"), rs.getFloat("acu_gr1_mes12"), filtros.curvaA, filtros.curvaB));
                        view.setMES13(rs.getInt("mes13"));
                        view.setCURVAMES13(calc.calculoAbc(rs.getInt("mes13"), rs.getFloat("part_gr1_mes13"), rs.getFloat("acu_gr1_mes13"), filtros.curvaA, filtros.curvaB));
                        ...
                        view.setCURVAGERAL(calc.calculoAbc(rs.getInt("acu_gr1"), rs.getFloat("part_gr1"), rs.getFloat("acu_gr1"), filtros.curvaA, filtros.curvaB));
